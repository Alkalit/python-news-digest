...
class IndexViewTest(TestCase):
    ...
    def test_context_var_items_if_has_related_not_active_items(self):
        ...
        Item.objects.create(title='Item 1 title', link='pass@pass.com', version=2,
    ...
    def test_context_var_items_if_has_related_active_items(self):
        ...
        item = Item.objects.create(title='Item 1 title', link='pass@pass.com', version=2,
                            section=section, issue=issue, status='active')
    ...
    def test_context_var_items_ordering(self):
        ...
        item1 = Item.objects.create(title='Item 1 title', link='pass@pass.com', version=2,
                            section=section1, priority=3, issue=issue, status='active')

        item2 = Item.objects.create(title='Item 1 title', link='pass@pass.com', version=1,
                            section=section1, priority=3, issue=issue, status='active')

        section2 = Section.objects.create(title='Section 2 title', priority=2)
        item3 = Item.objects.create(title='Item 1 title', link='pass@pass.com', version=1,
                            section=section2, priority=1, issue=issue, status='active')

        response = self.client.get('/')

        self.assertEqual(response.status_code, 200)
        self.assertEqual(list(response.context['items']), [item3, item1, item2])
